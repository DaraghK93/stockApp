...
function getStockPriceData(stocks) {
  ...
  const start_Date_month = moment(moment().subtract(1, 'month')).format(
    'YYYY-MM-DD'
  );
  const start_Date_year = moment(moment().subtract(1, 'year')).format(
    'YYYY-MM-DD'
  );
  ...
  for (var i = 0; i < dateRangeWeek.length; i++) {
    ...
    if (typeof weekly_prices[dateRangeWeek[i] + 'T20:00'] != 'undefined') {
      prices_week.push({
        date: dateRangeWeekNoYear[i],
        price: weekly_prices[dateRangeWeek[i] + 'T20:00']['Close'],
      });
    }
  }
  ...
  for (var i = 0; i < dateRangeMonth.length; i++) {
    ...
    if (typeof monthly_prices[dateRangeMonth[i] + 'T20:00'] != 'undefined') {
      prices_month.push({
        date: dateRangeMonthNoYear[i],
        price: monthly_prices[dateRangeMonth[i] + 'T20:00']['Close'],
      });
    }
  }
  ...
  for (var i = 0; i < dateRangeYear.length; i++) {
    ...
    if (typeof yearly_prices[dateRangeYear[i] + 'T20:00'] != 'undefined') {
      prices_year.push({
        date: dateRangeYearNoYear[i],
        price: yearly_prices[dateRangeYear[i] + 'T20:00']['Close'],
      });
    }
  }
