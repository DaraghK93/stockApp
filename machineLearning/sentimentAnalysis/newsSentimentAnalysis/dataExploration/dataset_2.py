...
visulisationOutputDir = './visulizations/dataset_2/'
...
if __name__ == "__main__":
    ...
    dataExploration.plotSentimentSplit(cleanedDF,f'Dataset Two - {len(cleanedDF.index)} Total News Headlines',f'{visulisationOutputDir}/sentimentSplit.png')