...
def main():
    ...
    posWordsList = featureEngineeringFunctions.readWordFileToList(posWords_loc)
    negWordsList = featureEngineeringFunctions.readWordFileToList(negWords_loc)
    neuWordsList = featureEngineeringFunctions.readWordFileToList(neuWords_loc)
        ...
        features.append(
            (
                featureEngineeringFunctions.extractFeatures(
                    posTweet, posWordsList, negWordsList, neuWords=neuWordsList
                ),
                "positive",
            )
        )
    for negTweet in negTweets:
        features.append(
            (
                featureEngineeringFunctions.extractFeatures(
                    negTweet, posWordsList, negWordsList, neuWords=neuWordsList
                ),
                "negative",
            )
        )
    for neuTweet in neuTweets:
        features.append(
            (
                featureEngineeringFunctions.extractFeatures(
                    neuTweet, posWordsList, negWordsList, neuWords=neuWordsList
                ),
                "neutral",
            )
        )
