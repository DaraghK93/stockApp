                                ...
                                <Col s={6} md={7} lg={7} xl={7}>
                                    {showTop3 &&
                                        <Row xs={3} style={{ textAlign: "center" }}>
                                            <Col xs={4}>
                                                <Image src={leaderBoardInfo[1].avatar ? leaderBoardInfo[1].avatar: "/avatar_3.jpeg"} className="top3ImgStyle secondplace" />
                                            ...
                                            <Col xs={4}>
                                                ...
                                                <Image src={leaderBoardInfo[0].avatar ? leaderBoardInfo[0].avatar: "/avatar_3.jpeg"} className="top3ImgStyle firstplace" />
                                            ...
                                            <Col xs={4}>
                                                <Image src={leaderBoardInfo[2].avatar ? leaderBoardInfo[2].avatar: "/avatar_3.jpeg"} className="top3ImgStyle thirdplace" />
                                                        ...
                                                        (<Fragment key={`${item.user}-fragment`}>
                                                            <tr key={item.user} className="leaderboradRowStyle">
                                                                ...
                                                                <td className={showCol ? "leaderBoardShow" : "leaderBoardHide"} key={item.picture}><center>
                                                                    <Image src={item.avatar ? item.avatar : "/avatar_3.jpeg"} className="leaderBoardAvatarStyle" alt="user avatar"></Image>
                                                                </center>
                                                                </td>
