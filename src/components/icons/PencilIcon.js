...
function PencilIcon(props) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 64 64" {...props}>
        ...
        <path fill="#ed4c5c" d="m61.3 4.6l-1.9-1.9C55.8-.9 50-.9 46.3 2.7l-6.5 6.5l15 15l6.5-6.5c3.6-3.6 3.6-9.5 0-13.1"></path>
        ...
        <path fill="#333" d="M.3 61.1c-.9 2.4.3 3.5 2.7 2.6l8.2-3.1l-7.7-7.7l-3.2 8.2"></path>
