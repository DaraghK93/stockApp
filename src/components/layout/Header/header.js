...
function Header() {
  ...
  return (
    <Navbar expanded={expanded} fixed="top" expand="lg" variant="dark"
      className="navbar">
      <Container>
        <Navbar.Brand style={{ color: 'white', verticalAlign:"middle", alignContent:"center" , display:"inline-block"}} as={NavLink} to="/game"><img style={{marginBottom: "3px",verticalAlign:"middle" ,height:"1.2rem", marginTop:"auto", marginBottom:"auto"}} src="./FinOptimizeLogoWhiteNoText.png" alt="logo"/> FIN<span className="navbar-brand mb-0 h1">OPTIMISE</span></Navbar.Brand>
