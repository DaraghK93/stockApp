...
function StockSummary() {
    ...
    return(
        ...
        <>
        <h2 className="stockdiscoveryRowTitle">Suggested For You<Person/> <InfoButtonModal title="Personalised Recommendations" info={
                        <div>
        ...
        <h3 className="stockdiscoveryRow">Recommended <IcBaselineCurrencyExchange/><InfoButtonModal title="Recommended" info={
                        <div>
                            ...
                            <p> If you have not yet made a transaction, the recommender system will give you recommendations based on companies<mark className="positive">similar</mark>to the<mark className="positive">highest positive mover</mark>over the<mark className="bold">past 24 hours.</mark></p>
                        </div>} /></h3>
        <SideScrollMenu>
        ...
        <h2 className="stockdiscoveryRowTitle">Top Movers <Timeline /> <InfoButtonModal title="Top Movers" info={
                        <div>
                            <p>This section displays the top<mark className="positive">positive</mark>and<mark className="negative">negative</mark> movers over the<mark className="bold">past 24 hour period.</mark></p>
                        </div>} /></h2>
