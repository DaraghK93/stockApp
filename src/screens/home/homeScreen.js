  ...
  return (
    <>
      <Container className='splash-page-container'>
        ...
        <Row>
          <Col>
            <Image thumbnail src={'FinOptimizeLogo.png'}></Image>
          </Col>
        </Row>
      </Container>
        ...
        <div className='stockDisplay'>
          <div className='stockDisplayCol'>
            <SideScrollMenu>
              {stocks.map((stockObj) => (
                <div
                  className='sideScrollCard not-clickable'
                  key={stockObj._id}
                >
      ...
      <Container>
        <Row>
          <Row className='pt-5'>
            <Col>
              <p style={{ textAlign: 'center' }}>
                Get the latest news and tweets on each stock. With sentiment classification
              </p>
            </Col>
          </Row>
          <Col sm md={8} className='offset-md-2'>
